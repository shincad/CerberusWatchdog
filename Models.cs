...
namespace EnhancedWatchdog
{
    ...
    public class ProcessInfo
    {
        ...
        // 프로세스 개별 스케줄 재시작 설정
        public bool EnableScheduledRestart { get; set; } = false;        // 스케줄 재시작 활성화
        public ScheduledRestartType ScheduledRestartType { get; set; } = ScheduledRestartType.Daily; // 재시작 타입
        public int ScheduledRestartHour { get; set; } = 23;               // 재시작 시간 (시)
        public int ScheduledRestartMinute { get; set; } = 30;             // 재시작 시간 (분)
        public DayOfWeek ScheduledRestartDayOfWeek { get; set; } = DayOfWeek.Sunday; // 주간 재시작 요일
        public DateTime? LastScheduledRestart { get; set; } = null;       // 마지막 스케줄 재시작 시간
    ...
    // 프로세스 스케줄 재시작 타입 열거형
    public enum ScheduledRestartType
    {
        Daily = 0,    // 매일
        Weekly = 1    // 매주
    }
